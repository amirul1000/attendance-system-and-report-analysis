...
?>
<a href="index.php?cmd=edit" class="btn green">Add a sap_activity_log</a> <br><br>
	         ...
	         <div class="table-responsive">	
					         ...
					         <div class="table-responsive">	
				                <table class="table">
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  $hash    =  getTableFieldsName("SAP_ACTIVITY_LOG");
										...
										<td nowrap="nowrap" align="right">
										  <input type="hidden" name="cmd" id="cmd" value="search_sap_activity_log" >
			  ...
			  <td>SAP END DATE</td>
						 ...
						 <?php
								...
								$info["fields"] = array("SAP_ACTIVITY_LOG.*"); 
								$info["where"]   = "1   $whrstr ORDER BY SAL_ID DESC  LIMIT $offset, $rowsPerPage";
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
							  <td><?=$arr[$i]['SAL_USER_ID']?></td>
                              <td><?=$arr[$i]['SAP_OBJECT']?></td>
                              <td><?=$arr[$i]['SAP_OBJECT_NAME']?></td>
                              <td><?=$arr[$i]['SAP_OBJECT_DESC']?></td>
                              <td><?=$arr[$i]['SAP_STR_DATE']?></td>
                              <td><?=$arr[$i]['SAP_END_DATE']?></td>
			  
							  <td nowrap >
								  <a href="index.php?cmd=edit&SAL_ID=<?=$arr[$i]['SAL_ID']?>"  class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a>
								  <a href="index.php?cmd=delete&SAL_ID=<?=$arr[$i]['SAL_ID']?>" class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-times"></i>Delete</a> 
							 </td>
						   ...
						   <td colspan="10" align="center">
							  <?php              
									  unset($info);
									   ...
									   $info["where"]   = "1  $whrstr ORDER BY SAL_ID DESC";
