...
?>
<a href="index.php?cmd=edit" class="btn green">Add an USER</a> <br><br>
									  ...
									  <TR>
										<TD  nowrap="nowrap">
										  <?php
											  ...
											  $hash    = array_diff($hash,array("USER_ID"));
										  ?>
										  Search Key:
				   ...
				   <td> 
				      ...
				      <div class="table-responsive">	
						 ...
						 <?php
								...
								$info["where"]   = "1   $whrstr ORDER BY USER_ID DESC  LIMIT $offset, $rowsPerPage";
						 ...
						 ?>
							<tr bgcolor="<?=$row?>" onmouseover=" this.style.background='#ECF5B6'; " onmouseout=" this.style.background='<?=$row?>'; ">
                              ...
                              <td><?=$arr[$i]['USER_PASS']?></td>
                              <td><?=$arr[$i]['USER_COMPANY_NAME']?></td>			  
							  <td nowrap >
								  <a href="index.php?cmd=edit&USER_ID=<?=$arr[$i]['USER_ID']?>"  class="btn default btn-xs purple"><i class="fa fa-edit"></i>Edit</a>
								  <a href="index.php?cmd=delete&USER_ID=<?=$arr[$i]['USER_ID']?>" class="btn btn-sm red filter-cancel"  onClick=" return confirm('Are you sure to delete this item ?');"><i class="fa fa-times"></i>Delete</a> 
							 </td>
						   ...
						   <td colspan="10" align="center">
							  <?php              
									  unset($info);
									   ...
									   $info["where"]   = "1  $whrstr ORDER BY USER_ID DESC";
