...
*/
  ...
  $sqlS = "SELECT * FROM demosapefficiency.SAP_ACTIVITY_LOG where (CAST(SAP_STR_DATE as date) between '".$STR_DATE."' and '".$END_DATE."' AND SAL_USER_ID=".$USER_ID.") OR (CAST(SAP_END_DATE as date) between '".$STR_DATE."' and '".$END_DATE."' AND SAL_USER_ID=".$USER_ID.")";
