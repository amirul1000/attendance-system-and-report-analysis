 ...
 if ($result1->num_rows > 0)
  {
   ...
   $sql2 = "SELECT UC_USER_ID as userid FROM demosapefficiency.USER_CONFIRMATION where (TIME_TO_SEC( UC_TIME_DELTA )-TIME_TO_SEC( UC_ATT_WORKING ))>".$Detected_Hours." AND UC_USER_ID=".$value." AND CAST(UC_DATE as DATE) between '".$STR_DATE."' and '".$END_DATE."'" ;
...
/*
  ...
  $sql = "SELECT UC_USER_ID as userid FROM demosapefficiency.USER_CONFIRMATION where (TIME_TO_SEC( UC_TIME_DELTA )-TIME_TO_SEC( UC_ATT_WORKING ))>".$Detected_Hours." AND CAST(UC_DATE as DATE) between '".$STR_DATE."' and '".$END_DATE."' group by UC_USER_ID";
