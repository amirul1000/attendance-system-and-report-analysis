...
$sqlS = "select count(SAL_USER_ID) AS count FROM demosapefficiency.SAP_ACTIVITY_LOG where CAST(SAP_STR_DATE as DATE) between '".$STR_DATE."' and '".$END_DATE."'" ;
...
$sqlATT = "select count(ATT_USER_ID) AS count FROM demosapefficiency.ATTENDANCE where CAST(ATT_STR_DATE as DATE) between '".$STR_DATE."' and '".$END_DATE."'" ;
